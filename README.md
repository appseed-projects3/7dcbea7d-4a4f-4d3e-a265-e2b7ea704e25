...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-21 02:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7dcbea7d-4a4f-4d3e-a265-e2b7ea704e25.git
$ cd 7dcbea7d-4a4f-4d3e-a265-e2b7ea704e25
```
